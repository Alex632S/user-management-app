...
const styles = {
  "pages/index.vue": () => import('./index-styles.BVgVtZ9E.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&scoped=48ee800b&lang.css": () => import('./index-styles.BVgVtZ9E.mjs').then(interopDefault),
